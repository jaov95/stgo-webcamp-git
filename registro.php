                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="number" id="pase_dia" min="0" size="3" placeholder="0" step="1">
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="number" id="pase_completo" min="0" size="3" placeholder="0" step="1">
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="tabla-precio">
                            <h3>Pase 2 Dias (Viernes y Sábado)</h3>
                            <p class="numero">$45</p>
                            <ul>
                                <li><i class="fas fa-check"></i>Bocadillos Gratis</li>
                                <li><i class="fas fa-check"></i>Todas Las Conferencias</li>
                            ...
                            <div class="orden">
                                ...
                                <input type="number" id="pase_dos_dias" min="0" size="3" placeholder="0" step="1">
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        <div class="orden">
                            ...
                            <input type="number" min="0" size="3" id="camisa_evento" placeholder="0" step="1">
                        </div>

                        <div class="orden">
                            <label for="etiquetas">Paquete de 10 etiquetas 2$ <small>(HTML5, CSS3, JS, Chrome)</small></label>
                            <input type="number" min="0" size="3" id="etiquetas" placeholder="0" step="1">
                        </div>
                        ...
                        <div class="orden">
                            ...
                            <select name="regalo" id="regalo" required>
                                ...
                                <option value="LAP">Lapices</option>
                            </select>
                        </div>
                    ...
                    <div class="total">
                        ...
                        <input id="btnRegistro" class="btn" type="submit" value="Pagar">
                    </div>
                </div>
            </div>
